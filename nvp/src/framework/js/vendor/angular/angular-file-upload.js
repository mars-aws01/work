...
(function (angular, factory) {
    ...
    var app = angular.module('angularFileUploadV2', []);
        ...
        .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
            function (fileUploaderOptions, $rootScope, $http, $window, $compile) {
                ...
                FileUploader.prototype.removeFromQueue = function (value) {
                    ...
                    if (item && item.isUploading) item.cancel();
        ...
        .directive('nvFileSelect', ['$parse', 'FileUploader', function ($parse, FileUploader) {
            return {
                link: function (scope, element, attributes) {
                    ...
                    uploader.isHTML5 || element.removeAttr('multiple');

                    element.bind('change', function () {
                        scope.$emit('file:add', uploader.isHTML5 ? this.files : this, scope.$eval(attributes.nvFileSelect));
                        (uploader.isHTML5 && element.attr('multiple')) && element.prop('value', null);
                    });
