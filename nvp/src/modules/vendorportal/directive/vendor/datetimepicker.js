 ...
 */
  ...
  angular.module('ngDatetimepicker', [])
    ...
    .directive('datetimepicker', ['$log', 'dateTimePickerConfig', '$filter', function datetimepickerDirective($log, defaultConfig,$filter) {
      ...
      return {
        ...
        '   <thead>' +
        '       <tr>' +
        '           <th class="left" data-ng-click="changeView(data.currentView, data.leftDate, $event)" data-ng-disabled="!data.leftDate.selectable"><i class="icon-arrow-left"/></th>' +
        '           <th class="switch" colspan="5" data-ng-disabled="!data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)">{{ data.previousViewDate.display }}</th>' +
        '           <th class="right" data-ng-click="changeView(data.currentView, data.rightDate, $event)" data-ng-disabled="!data.rightDate.selectable"><i class="icon-arrow-right"/></th>' +
        '       </tr>' +
        '       <tr>' +
        ...
        link: function link(scope, element, attrs, ngModelController) {
          ...
          if (attrs.datetimepickerConfig) {
              ...
              if (directiveConfig.dropdownSelector && directiveConfig.dropdownSelector === scope.$parent.$id) {
                  directiveConfig.dropdownSelector = '#' + directiveConfig.dropdownSelector;
              }
          }
