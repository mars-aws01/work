 ...
 * @author mm67
 */
public class FunctionalACK997SchemaVistorTest extends X12SchemaVisitorTestBase {
    @Test
    public void visit_x12_997_schema_test() 
            throws IOException,
        ...
        X12SchemaVisitor visitor = new X12SchemaVisitor(
                super.getSchemaFromFile(SchemaFile997));
